...
from nonebot.adapters.onebot.v11 import PrivateMessageEvent, MessageEvent, MessageSegment
...
async def _(event: PrivateMessageEvent, matcher: Matcher, content: Message = Arg()):
